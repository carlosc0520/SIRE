...
public class DomiciliadosConfig extends javax.swing.JPanel {
    ...
    private Map<String, String> options = Map.of("PLE NO DOMICILIADOS", "3", "SIRE NO DOMICILIADOS", "6");
    ...
    public DomiciliadosConfig(Empresa empresa) {
    ...
    private void obtenerCabecerasRendering(String keySelection) {
        try {
            ...
            Logger.getLogger(DomiciliadosConfig.class.getName()).log(Level.SEVERE, null, ex);
