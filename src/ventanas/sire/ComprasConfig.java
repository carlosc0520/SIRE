...
public class ComprasConfig extends javax.swing.JPanel {
    ...
    private Map<String, String> options = Map.of("PLE COMPRAS", "1", "SIRE COMPRAS", "4");
    ...
    public ComprasConfig(Empresa empresa) {
    ...
    private void obtenerCabecerasRendering(String keySelection) {
        try {
            ...
            Logger.getLogger(ComprasConfig.class.getName()).log(Level.SEVERE, null, ex);
